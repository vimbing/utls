...
import (
	...
	"github.com/vimbing/utls/internal/fips140tls"
	"github.com/vimbing/utls/internal/hpke"
	"github.com/vimbing/utls/internal/tls13"
)
...
func (c *UConn) echTranscriptMsg(outer *clientHelloMsg, echCtx *echClientContext) (err error) {
	...
	// See https://github.com/vimbing/utls/blob/e430876b1d82fdf582efc57f3992d448e7ab3d8a/ech.go#L276-L283
